...
fun HomeBodyPreview() {
    InventoryTheme {
        HomeBody(listOf(
            Item(1, "Game", 100.0, 20, "test@example.com", "777", "test"), Item(2, "Pen", 200.0, 30,"test@example.com", "777", "test"), Item(3, "TV", 300.0, 50, "test@example.com", "777", "test")
        ), onItemClick = {})
    }
}
...
fun InventoryItemPreview() {
    InventoryTheme {
        InventoryItem(
            Item(1, "Game", 100.0, 20, "test@example.com", "777", "test"),
        )
    }
}
